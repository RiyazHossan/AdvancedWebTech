<html>
    ...
    <br><br>
     <h1>Edit User</h1>
    <form action= "<?php echo e(route('editUser')); ?>" class "form-group" method = "post">
...
<?php /**PATH C:\xampp\htdocs\Riyaz\APWT_TASK_3\resources\views/admin/editUser.blade.php ENDPATH**/ ?>